    ...
    <div className="p-8 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
        ...
        <div className="lg:col-span-2">
          <div 
            {...getRootProps()}
            className={`h-full min-h-[300px] border-2 border-dashed rounded-3xl flex flex-col items-center justify-center p-12 transition-all cursor-pointer relative overflow-hidden ${
              isDragActive ? 'border-emerald-500 bg-emerald-500/5' : 'border-emerald-900/40 bg-[#0d1410]/60 hover:bg-[#0d1410]/90 hover:border-emerald-700/50'
            }`}
          >
            <input {...getInputProps()} />
